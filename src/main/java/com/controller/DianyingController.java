    ...
    */
    ...
    public R save(@RequestBody DianyingEntity dianying, HttpServletRequest request){
        ...
        Wrapper<DianyingEntity> queryWrapper = new EntityWrapper<DianyingEntity>()
            ...
            .eq("dianying_danyan", dianying.getDianyingDanyan())
            .eq("dianying_bianju", dianying.getDianyingBianju())
            .eq("dianying_address", dianying.getDianyingAddress())
            .eq("dianying_yuyan", dianying.getDianyingYuyan())
            .eq("dianying_shijian", dianying.getDianyingShijian())
            .eq("dianying_pianchang", dianying.getDianyingPianchang())
...
//                            dianyingEntity.setDianyingPhoto("");//照片
//                            dianyingEntity.setDianyingDanyan(data.get(0));                    //导演 要改的
//                            dianyingEntity.setDianyingBianju(data.get(0));                    //编剧 要改的
//                            dianyingEntity.setDianyingAddress(data.get(0));                    //制片国家/地区 要改的
//                            dianyingEntity.setDianyingYuyan(data.get(0));                    //语言 要改的
//                            dianyingEntity.setDianyingShijian(data.get(0));                    //上映日期 要改的
//                            dianyingEntity.setDianyingPianchang(data.get(0));                    //片长 要改的
    ...
    */
    ...
    public R list(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        if(params.containsKey("aaaa")){
            ...
            if(userId.getDianyingTypes() != null){
                params.put("dianyingTypes",userId.getDianyingTypes());
            }
        }
        // 没有指定排序字段就默认id倒序
