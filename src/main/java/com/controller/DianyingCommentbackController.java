    ...
    */
    ...
    public R save(@RequestBody DianyingCommentbackEntity dianyingCommentback, HttpServletRequest request){
        ...
        if(false)
            ...
            dianyingCommentback.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
...
//            dianyingCommentback.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        dianyingCommentback.setUpdateTime(new Date());
    ...
    */
    ...
    public R save( String fileName){
        ...
        try {
            List<DianyingCommentbackEntity> dianyingCommentbackList = new ArrayList<>();//上传的东西
...
//                            dianyingCommentbackEntity.setDianyingId(Integer.valueOf(data.get(0)));   //电影 要改的
//                            dianyingCommentbackEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            dianyingCommentbackEntity.setDianyingCommentbackText(data.get(0));                    //评价内容 要改的
//                            dianyingCommentbackEntity.setReplyText(data.get(0));                    //回复内容 要改的
//                            dianyingCommentbackEntity.setInsertTime(date);//时间
//                            dianyingCommentbackEntity.setUpdateTime(new Date(data.get(0)));          //回复时间 要改的
//                            dianyingCommentbackEntity.setCreateTime(date);//时间
                            dianyingCommentbackList.add(dianyingCommentbackEntity);
                        ...
                        //查询是否重复
                        dianyingCommentbackService.insertBatch(dianyingCommentbackList);
                        return R.ok();
                    }
                }
            }
