  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='喜欢类型' prop="dianyingTypes">
                 <el-select v-model="ruleForm.dianyingTypes" placeholder='请选择喜欢类型'>
                     <el-option
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.dianyingTypes)&& 'yonghu'==this.flag){
                             this.$message.error('喜欢类型不能为空');
                             return
                         }
