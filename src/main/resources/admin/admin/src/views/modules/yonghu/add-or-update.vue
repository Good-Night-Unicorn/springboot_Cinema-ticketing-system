        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="喜欢类型" prop="dianyingTypes">
                        <el-select v-model="ruleForm.dianyingTypes" :disabled="ro.dianyingTypes" placeholder="请选择喜欢类型">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="喜欢类型" prop="dianyingValue">
                        <el-input v-model="ruleForm.dianyingValue"
                            placeholder="喜欢类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   dianyingTypes: [
                              { required: true, message: '喜欢类型不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
